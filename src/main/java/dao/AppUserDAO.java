...
import utils.EncrytedPasswordUtils;
...
public class AppUserDAO {
    ...
    public AppUser createAppUser(Connection<?> connection) {
        ...
        String encrytedPassword = EncrytedPasswordUtils.encrytePasswordEncoder(randomPassword);
        //
        appUser = new AppUser();
    ...
    public AppUser registerNewUserAccount(AppUserForm appUserForm, List<String> roleNames) {
        ...
        appUser.setEnabled(true);
        String encrytedPassword = EncrytedPasswordUtils.encrytePasswordEncoder(appUserForm.getPassword());
        appUser.setEncrytedPassword(encrytedPassword);
        this.entityManager.persist(appUser);
